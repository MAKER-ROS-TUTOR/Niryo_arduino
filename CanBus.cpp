...
void CanBus::setup()
{
  ...
  if(can_driver->begin(MCP_STDEXT, CAN_500KBPS, MCP_8MHZ) == CAN_OK) {
...
void CanBus::writePosition()
{
 ...
 // Serial.print("Canbus write position:: ");
 // Serial.println(pos);
}
      ...
      case CAN_CMD_SYNCHRONIZE:
        {
          ...
          if( begin_traj) Serial.println("True");
          else
